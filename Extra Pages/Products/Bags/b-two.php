...
<php>
	...
	<title>Kenti Spot Mix Bag | PHASHION</title>
					...
					<div class="owl-carousel owl-carousel-fullwidth product-carousel">
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/bagsimages/prodAf2.jpg" alt="user">
								</figure>
							</div>
						</div>
						...
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/bagsimages/prodAfr5.jpg" alt="user">
								</figure>
							</div>
						</div>
						...
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/bagsimages/prodAfr8.jpg" alt="user">
								</figure>
							</div>
						</div>
					...
					<div class="fh5co-tabs animate-box">
						...
						<div class="fh5co-tab-content-wrap">
							...
							<div class="fh5co-tab-content tab-content active" data-tab-content="1">
								<div class="col-md-10 col-md-offset-1">
									<span class="price">Price: GHS 400</span>
									<h2>Kenti Spot Mix Bag</h2>
