...
<html>
	...
	<title>Crawling Tortoise Bag | PHASHION</title>
				...
				<div class="col-md-10 col-md-offset-1 animate-box">
					<div class="owl-carousel owl-carousel-fullwidth product-carousel">
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/bagsimages/prodAfr3.jpg" alt="user">
								</figure>
							</div>
						</div>
						...
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/bagsimages/prodAfr4.jpg" alt="user">
								</figure>
							</div>
						</div>
						...
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/bagsimages/prodAfr7.jpeg" alt="user">
								</figure>
							</div>
						</div>
					...
					<div class="row animate-box">
						<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
							<h2>                            <h3><a href="#">Crawling Tortoise Bag </a></h3>
                            </h2>
							<p>
					...
					<div class="fh5co-tabs animate-box">
						...
						<div class="fh5co-tab-content-wrap">
							...
							<div class="fh5co-tab-content tab-content active" data-tab-content="1">
								<div class="col-md-10 col-md-offset-1">
									<span class="price">Price: GHS 300</span>
									<h2>Crawling Tortoise Bag</h2>
									<p>Do you like bags? Yes?</p>

									<p>Then you're gonna love our bags.</p>
							...
							<div class="fh5co-tab-content tab-content" data-tab-content="2">
								<div class="col-md-10 col-md-offset-1">
									...
									<ul>
										<li>Wearable.</li>
										<li>Edible.</li>
										<li>Grants you massive wealth status in the right time.</li>
										<li>Looks fresh.</li>
									</ul>
							...
							<div class="fh5co-tab-content tab-content" data-tab-content="3">
								<div class="col-md-10 col-md-offset-1">
									...
									<div class="feed">
										<div>
											<blockquote>
												<p>I'll never go hungry again.</p>
											</blockquote>
											<h3>&mdash; Kofi Knight</h3>
											<span class="rate">
										...
										<div>
											<blockquote>
												<p>I'm the chief of Ketase now. Thank you!</p>
											</blockquote>
											<h3>&mdash; Dickson Ekubs</h3>
											<span class="rate">
												<i class="icon-star2"></i>
												<i class="icon-star2"></i>
												<i class="icon-star2"></i>
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						...
						<small class="block">Designed by <a href="PHASION" target="_blank">WEBTECHERS</a></small>
					</p>
					<p>
