...
<php>
	...
	<title>Kente Earrings | PHASHION</title>
					...
					<div class="owl-carousel owl-carousel-fullwidth product-carousel">
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/accessimages/a2.jpg" alt="user">
								</figure>
							</div>
						</div>
						...
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/accessimages/a6.jpg" alt="user">
								</figure>
							</div>
						</div>
						...
						<div class="item">
							<div class="active text-center">
								<figure>
									<img src="../../../images/accessimages/a7.jpg" alt="user">
								</figure>
							</div>
						</div>
					...
					<div class="fh5co-tabs animate-box">
						...
						<div class="fh5co-tab-content-wrap">
							...
							<div class="fh5co-tab-content tab-content active" data-tab-content="1">
								<div class="col-md-10 col-md-offset-1">
									<span class="price">Price: GHS 250</span>
									<h2>Masai Necklace</h2>
									<p>Do you like stuff? Yes?</p>

									<p>Then you're gonna love our stuff.</p>
							...
							<div class="fh5co-tab-content tab-content" data-tab-content="2">
								<div class="col-md-10 col-md-offset-1">
									...
									<ul>
										<li>Wearable.</li>
										<li>Edible.</li>
										<li>Grants you royalty status in some cultures.</li>
										<li>Looks fresh.</li>
									</ul>
