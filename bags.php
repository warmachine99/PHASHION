...
<php>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/bagsimages/mainProduct.jpg);">
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					...
					<h2>Banger Bags</h2>
					<p>These bags were designed by top Ghanaian bag designers tailor-made to fit your preferences</p>
				</div>
			</div>
