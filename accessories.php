...
<body>
	...
	<header id="fh5co-header" class="fh5co-cover fh5co-cover-sm" role="banner" style="background-image:url(images/accessimages/acc-main.jpg);">
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc animate-box" data-animate-effect="fadeIn">
							<h1>ACCESSORIES</h1>
							<h2>The Best African Accessories Money Can Buy</h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row animate-box">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading">
					<span>Leggo!</span>
					<h2>Accessible Accessories</h2>
					<p>These accessories were forged in Ghana's best gold mines, hand crafted to fit your aura</p>
				</div>
			</div>
			...
			<div class="row copyright">
                <div class="col-md-12 text-center">
                    <p>
                        ...
                        <small class="block">Designed by <a href="#" target="_blank">WEBTECHERS</a>
                    </p>
                    <p>
